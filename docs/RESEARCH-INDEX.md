...
- [Oráculo de dois endereços: 592.339 conteúdos únicos, 58.357.232 janelas raw32, zero hits — 17/09/2026](../_work/oraculo_duplo_2026-09-17/RELATORIO.md). Snapshot finito dos bytes salvos; condição de prêmio do segundo alvo não confirmada.
