...
[Guia da pesquisa](README.md) · [Histórico completo](../ENDGAME.md) ·
[Scripts e execução](../solver/README.md)

Os dados brutos mencionados nos relatórios podem ser locais. Consulte o
[guia de reprodução](README.md#reprodução) e o manifesto antes de executar.

## Cifras clássicas e linguagem
...
## Operações, fluxos e transposições
