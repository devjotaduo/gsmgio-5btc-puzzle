# -*- coding: utf-8 -*-
"""
Running key EXTERNA ao corpus da página: o texto do livro Time-Life *Cosmic Duality* (OCR em
...
LOG = os.path.join(SCR, "external_running_key.jsonl"); open(LOG, "w").close()
